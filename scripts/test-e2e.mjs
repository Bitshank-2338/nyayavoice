// End-to-end API test script for NyayaVoice
import { SAMPLE_EMPLOYMENT_AGREEMENT_ANALYSIS, SAMPLE_DOCUMENTS } from '../src/lib/documents/sample-documents.js';
import { analyzeDocumentHeuristically, answerDocumentQuestionHeuristically } from '../src/lib/ai/heuristic-analyzer.js';
...
console.log('✓ Sample Document verified (14 clauses, 7 obligations, 4 dates, 4 review items)');
...
console.log('✓ Raw text parser correctly extracted document structure and obligations');
